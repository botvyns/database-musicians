...
c.execute("""CREATE TABLE band (
	band_id integer primary key,
	band_name text, 
	label_id integer,
	stage_id integer,
	FOREIGN KEY (label_id) REFERENCES record_label(label_id),
	FOREIGN KEY (stage_id) REFERENCES eskadron_fest_stage_name(stage_id))
	 """)

c.execute("""CREATE TABLE eskadron_fest_stage_name (
	stage_id integer primary key,
	stage_name text, 
	performance_start text)
	""")

c.execute("""CREATE TABLE record_label (
...
c.execute("""CREATE TABLE instrument (
	instrument_id integer primary key,
	instrument_name text)
	""")

c.execute("""CREATE TABLE instrument_album (
